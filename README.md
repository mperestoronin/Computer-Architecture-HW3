...
## Тесты:
Для того, чтобы не вставлять большое количество скриншотов, я предоставил результаты работы программы на маленьких числах. Эти тесты демонстрируют работу программы и являются вполне исчерпывающими. Однако за программой куда интересней наблюдать при работе с куда большими числами. Поэтому рекомендую запустить программу с большими числами. Сами тесты вы можете посмотреть [тут](https://github.com/mperestoronin/Computer-Architecture-HW4/blob/main/Tests.md).
